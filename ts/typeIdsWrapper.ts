//このデータはHerobrine643928氏のChest-UI(https://github.com/Herobrine643928/Chest-UI)に手を加えenumにしたものです。
//This data is based on Herobrine643928's Chest-UI (https://github.com/Herobrine643928/Chest-UI), modified and enum.(Automatic translation)

//Minecraft v1.21.3

export namespace itemRendererIds {
	export enum DataIds {
		...
		"minecraft:light_gray_glowstick" = 620 + 7 / 65536,
		...
		"minecraft:lit_light_gray_glowstick" = 620 + 39 / 65536,
	...
	export enum Ids {
		...
		"minecraft:hard_black_stained_glass_panel" = -672,
		"minecraft:hard_red_stained_glass_panel" = -671,
		"minecraft:hard_green_stained_glass_panel" = -670,
		"minecraft:hard_brown_stained_glass_panel" = -669,
		"minecraft:hard_blue_stained_glass_panel" = -668,
		"minecraft:hard_purple_stained_glass_panel" = -667,
		"minecraft:hard_cyan_stained_glass_panel" = -666,
		"minecraft:hard_light_gray_stained_glass_panel" = -665,
		"minecraft:hard_gray_stained_glass_panel" = -664,
		"minecraft:hard_pink_stained_glass_panel" = -663,
		"minecraft:hard_lime_stained_glass_panel" = -662,
		"minecraft:hard_yellow_stained_glass_panel" = -661,
		"minecraft:hard_light_blue_stained_glass_panel" = -660,
		"minecraft:hard_magenta_stained_glass_panel" = -659,
		"minecraft:hard_orange_stained_glass_panel" = -658,
		...
		// "minecraft:mangrove_door" = -493,//上半分だけ
		...
		// "minecraft:warped_door" = -245,//上半分しかない
		// "minecraft:crimson_door" = -244,//上半分しかない
		...
		// "minecraft:nether_sprouts" = -238,//下に寄ってる
		...
		// "minecraft:smooth_stone_slab" = 44,//同じ？
		...
		// "minecraft:wooden_door" = 64,//上半分だけ
		"minecraft:ladder" = 65,
		"minecraft:rail" = 66,
		...
		// "minecraft:brewing_stand" = 117,//下の台座がない
		// "minecraft:cauldron" = 118,//横からのテクスチャ?
		...
		// "minecraft:flower_pot" = 140,//展開されてるかのようなテクスチャ
		...
		// "minecraft:spruce_door" = 193,//上半分だけ
		// "minecraft:birch_door" = 194,//上半分だけ
		// "minecraft:jungle_door" = 195,//上半分だけ
		// "minecraft:acacia_door" = 196,//上半分だけ
		// "minecraft:dark_oak_door" = 197,//上半分だけ
		...
		// "minecraft:concrete" = 236,//同じ？
		// "minecraft:concrete_powder" = 237,//同じ？
		"minecraft:chemistry_table" = 238,
		"minecraft:underwater_torch" = 239,
		"minecraft:chorus_plant" = 240,
		// "minecraft:stained_glass" = 241,//同じ？
		// "minecraft:camera" = 242,//同じ？
		...
		// "minecraft:armadillo_spawn_egg" = 511,//灰色のスポーンエッグ
